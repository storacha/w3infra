...
The [`multibase`](https://github.com/multiformats/multibase) encoded ED25519 keypair used as the signing key for the [content-claims api](https://github.com/web3-storage/content-claims).
