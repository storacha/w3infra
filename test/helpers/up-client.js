...
function getAuthLinkFromEmail (email, accessServiceUrl) {
  ...
  // TODO we should update the email and add an ID to this element to make this more robust - tracked in https://github.com/storacha/upload-service-infra/issues/208
