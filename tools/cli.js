...
import { updateSubscriptionConsumerProviders }  from './update-subscription-consumer-providers.js'
...
cli
  .command('update-subscription-consumer-providers', 'Update the provider field of subscription and consumer records to did:web:up.storacha.network')
  .action(updateSubscriptionConsumerProviders)
