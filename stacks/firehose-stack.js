...
import { getBucketConfig, getCdkNames, setupSentry } from './config.js'
...
export function UcanFirehoseStack({ stack, app }) {
  ...
  const deliveryStreamRoleName = getCdkNames(
    'ucan-stream-delivery-role',
    app.stage
  )
  ...
  const logGroupName = getCdkNames(
    'ucan-stream-delivery-error-logging',
    app.stage
  )
  ...
  const deliveryFirehose = new firehose.CfnDeliveryStream(
    stack,
    deliveryStreamName,
    {
      deliveryStreamName,
      ...
      extendedS3DestinationConfiguration: {
              ...
              parameters: [
                {
                  ...
                  parameterValue:
                    '{day: (.ts/1000) | strftime("%Y-%m-%d"), type: .type, op: (.value.att[0].can | gsub("/"; "_"))}',
                },
                {
        ...
        prefix:
          'logs/!{partitionKeyFromQuery:type}/!{partitionKeyFromQuery:op}/!{partitionKeyFromQuery:day}/',
  ...
  const manualDeliveryStreamName = getCdkNames(
    'manual-stream-delivery',
    app.stage
  )
  const manualDeliveryFirehose = new firehose.CfnDeliveryStream(
    stack,
    manualDeliveryStreamName,
    {
      deliveryStreamName: manualDeliveryStreamName,
      deliveryStreamType: 'DirectPut', // Changed to DirectPut
      extendedS3DestinationConfiguration: {
        bucketArn: streamLogBucket.bucketArn,
        roleArn: deliveryStreamRole.roleArn,
        bufferingHints: {
  ...
  manualDeliveryFirehose.node.addDependency(deliveryStreamRole)
    ...
    tableInput: {
      ...
      storageDescriptor: {
        ...
        columns: [
          ...
          {
            name: 'value',
            type: 'STRUCT<att:ARRAY<struct<can:STRING,with:STRING,nb:STRING>>,iss:STRING,aud:STRING>',
          },
          {
            name: 'out',
            type: 'STRUCT<error:STRUCT<name:STRING,message:STRING>,ok:STRING>',
          },
    ...
    tableInput: {
      ...
      storageDescriptor: {
        ...
        columns: [
          ...
          {
            name: 'value',
            type: 'STRUCT<att:ARRAY<struct<can:STRING,with:STRING,nb:STRUCT<size:BIGINT,link:STRUCT<_cid_slash:STRING>>>>,iss:STRING,aud:STRING>',
          },
          {
            name: 'out',
            type: 'STRUCT<error:STRUCT<name:STRING>,ok:STRUCT<status:STRING,link:STRUCT<_cid_slash:STRING>>>',
          },
          { name: 'ts', type: 'timestamp' },
        ],
        inputFormat: 'org.apache.hadoop.mapred.TextInputFormat',
    ...
    tableInput: {
      ...
      storageDescriptor: {
        ...
        columns: [
          ...
          {
            name: 'value',
            type: 'STRUCT<att:ARRAY<struct<can:STRING,with:STRING,nb:STRUCT<blob:STRUCT<size:BIGINT>>>>,iss:STRING,aud:STRING>',
          },
          {
            name: 'out',
            type: 'STRUCT<error:STRUCT<name:STRING>,ok:STRUCT<site:STRING>>',
          },
          { name: 'ts', type: 'timestamp' },
        ],
        inputFormat: 'org.apache.hadoop.mapred.TextInputFormat',
    ...
    tableInput: {
      ...
      storageDescriptor: {
        ...
        columns: [
          ...
          {
            name: 'value',
            type: 'STRUCT<att:ARRAY<struct<can:STRING,with:STRING,nb:STRUCT<blob:STRUCT<size:BIGINT>,space:STRING,cause:STRUCT<_cid_slash:STRING>>>>,iss:STRING,aud:STRING>',
          },
          // No need to store URL for allocation here for now
          {
            name: 'out',
            type: 'STRUCT<error:STRUCT<name:STRING>,ok:STRUCT<size:BIGINT>>',
          },
          { name: 'ts', type: 'timestamp' },
        ],
        inputFormat: 'org.apache.hadoop.mapred.TextInputFormat',
    ...
    tableInput: {
      ...
      storageDescriptor: {
        ...
        columns: [
          ...
          {
            name: 'value',
            type: 'STRUCT<att:ARRAY<struct<can:STRING,with:STRING,nb:STRUCT<blob:STRUCT<size:BIGINT>,space:STRING>>>,iss:STRING,aud:STRING>',
          },
          // No need to store URL for allocation here for now
          {
            name: 'out',
            type: 'STRUCT<error:STRUCT<name:STRING>,ok:STRUCT<site:STRUCT<_cid_slash:STRING>>>',
          },
          { name: 'ts', type: 'timestamp' },
        ],
        inputFormat: 'org.apache.hadoop.mapred.TextInputFormat',
    ...
    tableInput: {
      ...
      storageDescriptor: {
        ...
        columns: [
          ...
          {
            name: 'value',
            type: 'STRUCT<att:ARRAY<STRUCT<can:STRING,with:STRING,nb:STRUCT<root:STRUCT<_cid_slash:STRING>,shards:ARRAY<STRUCT<_cid_slash:STRING>>>>>,iss:STRING,aud:STRING>',
          },
          {
            name: 'out',
            type: 'STRUCT<error:STRUCT<name:STRING>,ok:STRUCT<root:STRUCT<_cid_slash:STRING>,shards:ARRAY<STRUCT<_cid_slash:STRING>>>>',
          },
          { name: 'ts', type: 'timestamp' },
        ],
        inputFormat: 'org.apache.hadoop.mapred.TextInputFormat',
    ...
    tableInput: {
      ...
      storageDescriptor: {
        ...
        columns: [
          ...
          {
            name: 'value',
            type: 'STRUCT<att:ARRAY<struct<can:STRING,with:STRING,nb:STRUCT<link:STRUCT<_cid_slash:STRING>>>>,iss:STRING,aud:STRING>',
          },
          {
            name: 'out',
            type: 'STRUCT<error:STRUCT<name:STRING>,ok:STRUCT<size:BIGINT>>',
    ...
    tableInput: {
      ...
      storageDescriptor: {
        ...
        columns: [
          ...
          {
            name: 'value',
            type: 'STRUCT<att:ARRAY<struct<can:STRING,with:STRING,nb:STRUCT<digest:BINARY>>>,iss:STRING,aud:STRING>',
          },
          {
            name: 'out',
            type: 'STRUCT<error:STRUCT<name:STRING>,ok:STRUCT<size:BIGINT>>',
    ...
    tableInput: {
      ...
      storageDescriptor: {
        ...
        columns: [
          ...
          {
            name: 'value',
            type: 'STRUCT<att:ARRAY<struct<can:STRING,with:STRING,nb:STRUCT<provider:STRING,consumer:STRING>>>,iss:STRING,aud:STRING>',
          },
          {
            name: 'out',
            type: 'STRUCT<error:STRUCT<name:STRING>,ok:STRUCT<root:STRUCT<_cid_slash:STRING>>>',
          },
          { name: 'ts', type: 'timestamp' },
        ],
        inputFormat: 'org.apache.hadoop.mapred.TextInputFormat',
  ...
  // and in the data browser in the Athena Query editor at
  // https://console.aws.amazon.com/athena/home#/query-editor
  const aggregateOfferTableName = getCdkNames(
    'aggregate-offer-table',
    app.stage
  )
  const aggregateOfferTable = new glue.CfnTable(
    stack,
    aggregateOfferTableName,
    {
      catalogId: Aws.ACCOUNT_ID,
      databaseName,
      tableInput: {
        ...
        storageDescriptor: {
          ...
          columns: [
            ...
            {
              name: 'value',
              type: 'STRUCT<att:ARRAY<struct<can:STRING,with:STRING,nb:STRUCT<aggregate:STRUCT<_cid_slash:STRING>>>>,iss:STRING,aud:STRING>',
            },
            {
              name: 'out',
              type: 'STRUCT<error:STRUCT<name:STRING>,ok:STRUCT<aggregate:STRUCT<_cid_slash:STRING>>>',
            },
            { name: 'ts', type: 'timestamp' },
          ],
          inputFormat: 'org.apache.hadoop.mapred.TextInputFormat',
  ...
  // and in the data browser in the Athena Query editor at
  // https://console.aws.amazon.com/athena/home#/query-editor
  const aggregateAcceptTableName = getCdkNames(
    'aggregate-accept-table',
    app.stage
  )
  const aggregateAcceptTable = new glue.CfnTable(
    stack,
    aggregateAcceptTableName,
    {
      catalogId: Aws.ACCOUNT_ID,
      databaseName,
      tableInput: {
  ...
  const inputOutputQuery = new athena.CfnNamedQuery(
    stack,
    inputOutputQueryName,
    {
...
`,
  ...
  const storesBySpaceQuery = new athena.CfnNamedQuery(
    stack,
    storesBySpaceQueryName,
    {
...
uploads_by_account AS (
  ...
  // https://console.aws.amazon.com/athena/home#/query-editor/saved-queries
  // and selecting the appropriate Workgroup from the dropdown in the upper right
  const uploadVolumeSizeQueryName = getCdkNames(
    'upload-volume-size-query',
    app.stage
  )
  const uploadVolumeSizeQuery = new athena.CfnNamedQuery(
    stack,
    uploadVolumeSizeQueryName,
    {
...
`,
  ...
  // https://console.aws.amazon.com/athena/home#/query-editor/saved-queries
  // and selecting the appropriate Workgroup from the dropdown in the upper right
  const uploadVolumeCountQueryName = getCdkNames(
    'upload-volume-count-query',
    app.stage
  )
  const uploadVolumeCountQuery = new athena.CfnNamedQuery(
    stack,
    uploadVolumeCountQueryName,
    {
...
`,
  ...
  // https://console.aws.amazon.com/athena/home#/query-editor/saved-queries
  // and selecting the appropriate Workgroup from the dropdown in the upper right
  const uploadsBySpaceAndSizeQueryName = getCdkNames(
    'uploads-by-space-and-size',
    app.stage
  )
  const uploadsBySpaceAndSizeQuery = new athena.CfnNamedQuery(
    stack,
    uploadsBySpaceAndSizeQueryName,
    {
...
`,
  ...
  // https://console.aws.amazon.com/athena/home#/query-editor/saved-queries
  // and selecting the appropriate Workgroup from the dropdown in the upper right
  const aggregateHoursToDataCommitedQueryName = getCdkNames(
    'aggregate-hours-to-data-commited-query',
    app.stage
  )
  const aggregateHoursToDataCommitedQuery = new athena.CfnNamedQuery(
    stack,
    aggregateHoursToDataCommitedQueryName,
    {
...
`,
  ...
  const athenaDynamoConnector = new sam.CfnApplication(
    stack,
    getCdkNames('athena-dynamo-connector', app.stage),
    {
  ...
  const dynamoDataCatalog = new athena.CfnDataCatalog(
    stack,
    dynamoDataCatalogName,
    {
  ...
  // https://console.aws.amazon.com/athena/home#/query-editor/saved-queries
  // and selecting the appropriate Workgroup from the dropdown in the upper right
  const spacesByAccountQueryName = getCdkNames(
    'spaces-by-account-query',
    app.stage
  )
  const spacesByAccountQuery = new athena.CfnNamedQuery(
    stack,
    spacesByAccountQueryName,
    {
...
`,
  ...
  // https://console.aws.amazon.com/athena/home#/query-editor/saved-queries
  // and selecting the appropriate Workgroup from the dropdown in the upper right
  const uploadsByAccountQueryName = getCdkNames(
    'uploads-by-account-query',
    app.stage
  )
  const uploadsByAccountQuery = new athena.CfnNamedQuery(
    stack,
    uploadsByAccountQueryName,
    {
