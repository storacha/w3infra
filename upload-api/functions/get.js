...
export const home = Sentry.AWSLambda.wrapHandler(wrapLambdaHandler('home', homeGet))
...
export const error = Sentry.AWSLambda.wrapHandler(wrapLambdaHandler('error', errorGet))
