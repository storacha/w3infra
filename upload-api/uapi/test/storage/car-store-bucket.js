...
/**
 * @deprecated
 * @implements {API.LegacyCarStoreBucket}
 */
export class CarStoreBucket {
  /**
   * @param {API.LegacyCarStoreBucketOptions & {http?: import('http')}} options
   */
  ...
  /**
   * @param {API.LegacyCarStoreBucketOptions & { server?: import('http').Server, url: URL, content: Map<string, Uint8Array> }} options
   */
  constructor({
    content,
    url,
