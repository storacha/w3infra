...
export const consumerTableProps = {
  ...
  globalIndexes: {
    consumer: {
      ...
      projection: ['provider', 'subscription'],
    },
    consumerV2: {
      partitionKey: 'consumer',
      projection: ['provider', 'subscription', 'customer'],
    },
    provider: { partitionKey: 'provider', projection: ['consumer'] },
    customer: {
      partitionKey: 'customer',
      projection: ['consumer', 'provider', 'subscription', 'cause'],
    },
  },
}
...
export const agentIndexTableProps = {
  ...
  primaryIndex: { partitionKey: 'taskkind', sortKey: 'identifier' },
}
